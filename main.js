...
function changeBGImage() {
		// Remove any puzzle pieces from the drop zones and append them back to the puzzle board
		...
		// Set the background image of the puzzle board to the selected image
